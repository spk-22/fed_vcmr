...
class IngestionPipeline:
    ...
    def process_metadata_streaming(self):
        ...
        test_manifest_path = DATA_ROOT / "structured-symlinks" / "val_list_jsfusion.txt"
        test_vids = set()
    ...
    def run_ingestion(self, limit=None):
        """Run the full ingestion using a producer-consumer pattern for speed."""
        from concurrent.futures import ThreadPoolExecutor
        from queue import Queue
        import threading
        
        print(f"Starting optimized resumable ingestion... (Limit: {limit})")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--limit", type=int, default=None, help="Limit number of videos to ingest")
